...
export class FreelancerIntegrationManager {
  ...
  // Method to get platform-specific service (for advanced operations)
  getPlatformService(platformName: string): PlatformService | undefined {
    return this.services.get(platformName);
  }
}
