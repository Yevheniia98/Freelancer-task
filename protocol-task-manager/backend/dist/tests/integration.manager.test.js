...
jest.mock('../services/upwork.service', () => {
    return {
        UpworkService: jest.fn().mockImplementation(() => ({
...
describe('FreelancerIntegrationManager', () => {
    ...
    let testUser;
    beforeEach(async () => {
        integrationManager = new integration_manager_1.FreelancerIntegrationManager();
        // Create test user
    ...
    describe('project synchronization', () => {
        ...
        it('should sync all platforms successfully', async () => {
            ...
            const projects = await project_model_1.Project.find({ userId: testUserId });
        ...
        it('should update existing project during sync', async () => {
            ...
            const existingProject = await project_model_1.Project.create({
                title: 'Old Title',
            ...
            const updatedProject = await project_model_1.Project.findById(existingProject._id);
        ...
        it('should handle sync errors gracefully', async () => {
            ...
            const mockService = integrationManager.getPlatformService('upwork');
    ...
    describe('project operations', () => {
        ...
        it('should resync individual project successfully', async () => {
            ...
            const updatedProject = await project_model_1.Project.findById(testProject._id);
        ...
        it('should fail to resync non-external project', async () => {
            ...
            const internalProject = await project_model_1.Project.create({
            ...
            const result = await integrationManager.resyncProject(internalProject._id.toString());
            expect(result).toBe(false);
        });
