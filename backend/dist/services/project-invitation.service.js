...
class ProjectInvitationService {
    ...
    async sendInvitation(invitation) {
        try {
            ...
            const emailHtml = this.generateInvitationEmail(invitation.projectName, invitation.inviterName, invitation.permission, invitationLink);
     ...
     */
    generateInvitationEmail(projectName, inviterName, permission, invitationLink) {
