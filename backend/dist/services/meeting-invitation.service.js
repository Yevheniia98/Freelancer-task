...
exports.MeetingInvitationService = void 0;
...
class MeetingInvitationService {
     ...
     */
    async sendMeetingInvitation(invitationData) {
        try {
     ...
     */
    async sendMeetingInvitations(participants, meetingData) {
        const results = {
            success: [],
            failed: []
        };
...
exports.MeetingInvitationService = MeetingInvitationService;
