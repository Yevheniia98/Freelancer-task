<template>
    <v-card class="rounded-lg mb-4 pa-6">
      ...
      <div class="d-flex align-center mb-5">
        <v-icon size="small" color="grey-darken-1" class="mr-2">mdi-calendar-outline</v-icon>
      ...
      <div class="d-flex mb-5">
        <v-avatar 
          ...
          :style="{ zIndex: index }"
        >
          <v-img :src="memberAvatars[memberId] || 'https://randomuser.me/api/portraits/lego/1.jpg'"></v-img>
        </v-avatar>
      ...
      <div class="d-flex justify-space-between align-center mb-2">
        <div class="text-caption text-grey-darken-1">Progress</div>
        <div class="text-caption font-weight-medium">{{ task.progress }}%</div>
      </div>
