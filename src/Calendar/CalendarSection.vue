  ...
  <v-app>
    ...
    <v-main class="main-content">
      ...
      <v-container fluid class="content-container px-6 pb-8">
        ...
        <div class="tool-section">
          <div class="section-header">
            <div class="section-title">
              <v-icon class="section-icon" color="primary">mdi-calendar-multiple</v-icon>
            ...
            <div class="event-type-item">
              <div class="event-type-card planning-card">
                <div class="event-type-icon-wrapper planning-icon">
                  <v-icon class="event-type-icon" color="white">mdi-lightbulb</v-icon>
                </div>
                <div class="event-type-info">
                  <h3 class="event-type-title">New Event Planning</h3>
                  <p class="event-type-description">Plan and organize new events</p>
                </div>
              </div>
            </div>
            ...
            <div class="event-type-item">
              <div class="event-type-card meeting-card">
                <div class="event-type-icon-wrapper meeting-icon">
                  <v-icon class="event-type-icon" color="white">mdi-account-group</v-icon>
                </div>
                <div class="event-type-info">
                  <h3 class="event-type-title">Meeting</h3>
                  <p class="event-type-description">Team meetings and discussions</p>
                </div>
              </div>
            </div>
            ...
            <div class="event-type-item">
              <div class="event-type-card report-card">
                <div class="event-type-icon-wrapper report-icon">
                  <v-icon class="event-type-icon" color="white">mdi-chart-line</v-icon>
                </div>
                <div class="event-type-info">
                  <h3 class="event-type-title">Generating Reports</h3>
                  <p class="event-type-description">Create and review reports</p>
                </div>
              </div>
            </div>
            ...
            <div class="event-type-item">
              <div class="event-type-card theme-card">
                <div class="event-type-icon-wrapper theme-icon">
                  <v-icon class="event-type-icon" color="white">mdi-palette</v-icon>
                </div>
                <div class="event-type-info">
                  <h3 class="event-type-title">Create New Theme</h3>
                  <p class="event-type-description">Design and development tasks</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="tool-section">
          <div class="section-header">
            <div class="section-title">
              <v-icon class="section-icon" color="warning">mdi-calendar</v-icon>
              <h2 class="section-heading">Calendar View</h2>
            </div>
        ...
        <div class="tool-section">
          <div class="section-header">
            <div class="section-title">
              <v-icon class="section-icon" color="success">mdi-clock-outline</v-icon>
          ...
          <div class="upcoming-events-grid">
            ...
            >
              <div class="upcoming-event-card" @click="openEventEditModal(event)">
                <div class="upcoming-event-icon-wrapper">
                  <v-icon class="upcoming-event-icon" color="white">
                    {{ getEventIcon(event.type) }}
                  </v-icon>
                </div>
                <div class="upcoming-event-info">
                  <h3 class="upcoming-event-title">{{ event.title }}</h3>
                  <div class="upcoming-event-date">{{ formatDate(event.date) }}</div>
      ...
      <v-card rounded="xl" flat border>
        <v-card-title class="hero-modal-header pa-6">
          <div class="modal-title">
            <v-icon class="mr-3" color="white">mdi-calendar-edit</v-icon>
    ...
    >
      <v-card rounded="xl" flat border>
        <v-card-title class="hero-modal-header pa-6">
          <div class="modal-title">
            <v-icon class="mr-3" color="white">mdi-calendar-month</v-icon>
            Events on {{ formatDetailDate(selectedDate) }}
          </div>
        </v-card-title>
          
        <v-card-text class="pa-6">
          <div v-if="eventsOnSelectedDate.length === 0" class="text-center py-8">
      ...
      <v-card rounded="xl" flat border>
        ...
        <v-card-text class="pa-6">
          <div class="text-center">
            <v-icon size="64" color="error">mdi-delete-circle</v-icon>
