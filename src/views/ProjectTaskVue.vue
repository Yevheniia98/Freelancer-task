    ...
    <div class="project-management">
        ...
        <v-main class="grey lighten-4 pa-4">
            ...
            <v-card-item>
              <div class="d-flex align-center">
                <div class="mr-4 bg-white rounded-circle pa-2">
                  <div class="bg-black rounded d-flex flex-column pa-2" style="width: 32px; height: 32px;">
                    <div class="d-flex">
                      <div class="white rounded-sm mr-1" style="width: 8px; height: 8px;"></div>
                      <div class="white rounded-sm" style="width: 8px; height: 8px;"></div>
                    </div>
                ...
                <div class="flex-grow-1">
                  <h1 class="text-h5 font-weight-bold">Slack brand logo design</h1>
                  <div class="d-flex align-center text-caption text-grey">
                    <span class="mr-4">Themes brand</span>
                    <span class="mr-4">Create Date: 10 Jul, 2024</span>
                    <span>Due date: 20 Jul, 2024</span>
                    <v-chip class="ml-4" color="light-green" size="small" label>New</v-chip>
                    <v-chip class="ml-2" color="pink-lighten-4" size="small" label>High</v-chip>
                  </div>
                </div>
                
                <div class="d-flex">
                  <v-btn icon="mdi-star-outline" variant="text" color="grey"></v-btn>
                  <v-btn icon="mdi-share-variant-outline" variant="text" color="grey"></v-btn>
                </div>
              </div>
            </v-card-item>
          </v-card>
          ...
          <v-row>
            <v-col cols="12" md="8">
              ...
              <v-card class="mb-4">
                <v-card-item>
                  ...
                  <v-card-text>
                    ...
                    <h3 class="text-h6 font-weight-medium mt-6 mb-2">File Formats</h3>
                    <ul class="pa-0">
                      <li class="d-flex mb-2">
                        <span class="mr-2">•</span>
                    ...
                    <v-row class="mt-6">
                      <v-col cols="12" sm="3">
                        <div class="text-caption text-grey">CREATE DATE:</div>
                        <div class="text-body-2">10 Jul, 2024</div>
                      </v-col>
                      <v-col cols="12" sm="3">
                        <div class="text-caption text-grey">DUE DATE:</div>
                        <div class="text-body-2">20 Jul, 2024</div>
                      </v-col>
                      <v-col cols="12" sm="3">
                        <div class="text-caption text-grey">PRIORITY:</div>
                        <v-chip class="mt-1" color="pink-lighten-4" size="small" label>High</v-chip>
                      </v-col>
                      <v-col cols="12" sm="3">
                        <div class="text-caption text-grey">STATUS:</div>
                        <v-chip class="mt-1" color="amber-lighten-3" size="small" label>In progress</v-chip>
                      </v-col>
                    </v-row>
                  </v-card-text>
                </v-card-item>
              ...
              <v-card class="mb-4">
                <v-card-item>
                  <v-card-title class="text-h6 font-weight-bold">RESOURCES</v-card-title>
                  
                  <v-card-text>
                    <v-row>
                      <v-col v-for="file in files" :key="file.id" cols="12" sm="6">
                        <v-card variant="outlined" class="d-flex align-center pa-3">
                          ...
                          <div>
                            <v-btn icon="mdi-download" variant="text" density="comfortable" color="grey"></v-btn>
              ...
              <v-card>
                <v-card-item>
                  <v-card-title class="text-h6 font-weight-bold">Comments</v-card-title>
                  
                  <v-card-text>
                    <div class="mb-6">
                      <div class="d-flex mb-6">
                        <v-avatar class="mr-3" size="40">
                          <v-img src="https://i.pravatar.cc/40?img=1" alt="User"></v-img>
                        </v-avatar>
                        <div class="flex-grow-1">
                          ...
                          <p class="text-body-2 text-grey-darken-1">Hi, everyone! I'll be taking care of the design system.</p>
                        </div>
                      </div>
                      
                      <div class="d-flex ml-12">
                        <v-avatar class="mr-3" size="40">
                          <v-img src="https://i.pravatar.cc/40?img=2" alt="User"></v-img>
                        </v-avatar>
                        <div class="flex-grow-1">
                          <div class="d-flex align-center mb-1">
                          ...
                          <p class="text-body-2 text-grey-darken-1">Hi, Nico! That's great—now I can focus on the illustrations</p>
                        </div>
                      </div>
                    </div>
                    
                    <h3 class="text-subtitle-1 font-weight-medium mb-2">Leave a comment</h3>
                    <v-textarea
                      v-model="comment"
                      variant="outlined"
                    ...
                    <div class="d-flex justify-end">
                      <v-btn icon="mdi-paperclip" variant="text" class="mr-2"></v-btn>
                      <v-btn color="teal" prepend-icon="mdi-send" @click="submitComment">
                        Send
                      </v-btn>
                    </div>
                  </v-card-text>
            ...
            <v-col cols="12" md="4">
              ...
              <v-card class="mb-4">
                <v-card-item>
                  <div class="d-flex justify-space-between align-center">
                    <v-card-title class="text-h6 font-weight-bold">Members</v-card-title>
                    <v-btn
                    ...
                    <v-list>
                      ...
                      >
                        <template v-slot:prepend>
                          <v-avatar size="40">
                            <v-img :src="member.avatar" alt="Member"></v-img>
                          </v-avatar>
                        </template>
              ...
              <v-card>
                <v-card-item>
                  <div class="d-flex justify-space-between align-center">
                    <v-card-title class="text-h6 font-weight-bold">Attachments</v-card-title>
                    <v-btn
                  ...
                  <v-card-text>
                    <v-list>
                      ...
                      >
                        <template v-slot:prepend>
                          <v-avatar color="teal-lighten-4" class="rounded">
                            <v-icon color="teal">mdi-file-outline</v-icon>
                          </v-avatar>
                        </template>
                        
                        <template v-slot:append>
                          <v-btn icon="mdi-download" variant="text" density="comfortable"></v-btn>
                          <v-btn icon="mdi-dots-vertical" variant="text" density="comfortable"></v-btn>
                        </template>
                      </v-list-item>
                    </v-list>
      ...
      <v-dialog v-model="showUploadModal" max-width="500">
        <v-card>
          ...
          <v-card-text>
            <v-row>
              <v-col cols="12">
                ...
                >
                  <v-icon size="large" class="mb-2">mdi-upload</v-icon>
              ...
              <v-col cols="12">
                ...
                >
                  <v-icon size="large" class="mb-2" color="primary">mdi-google-drive</v-icon>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="grey" variant="text" @click="showUploadModal = false">Cancel</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
        ...
        <v-card>
          ...
          <v-card-text>
            <v-tabs v-model="inviteTab">
              ...
              <v-tab value="gmail">Gmail</v-tab>
              <v-tab value="app">App Users</v-tab>
            </v-tabs>
            ...
            <v-window v-model="inviteTab" class="mt-4">
              ...
              <v-window-item value="app">
                ...
                <v-list class="overflow-y-auto" max-height="220" bg-color="grey-lighten-5">
                  <v-list-item
                    v-for="i in 5"
                    :key="i"
                    :title="`User Name ${i}`"
                  ...
                  >
                    <template v-slot:prepend>
                      <v-avatar size="36">
                        <v-img src="https://i.pravatar.cc/36" alt="User"></v-img>
                      </v-avatar>
                    </template>
          ...
          <v-card-actions>
            ...
            <v-btn color="primary" @click="inviteMember">Invite</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
    </div>
