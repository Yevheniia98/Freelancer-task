        ...
        <div class="tool-section">
          <div class="section-header">
            <div class="section-title">
              <v-icon class="section-icon" color="primary">mdi-view-dashboard</v-icon>
          ...
          <div class="project-overview-grid">
            ...
            <div class="overview-item">
              <div class="overview-card priority-card">
                ...
                <div class="overview-info">
                  ...
                  <div class="overview-amount">{{ priority }}</div>
            ...
            <div class="overview-item">
              <div class="overview-card status-card">
                <div class="overview-icon-wrapper status-icon">
                  <v-icon class="overview-icon" color="white">mdi-progress-check</v-icon>
                </div>
                <div class="overview-info">
                  <h3 class="overview-title">Status</h3>
                  <div class="overview-amount">{{ status }}</div>
            ...
            <div class="overview-item">
              <div class="overview-card team-card">
                ...
                <div class="overview-info">
                  <h3 class="overview-title">Team Size</h3>
                  <div class="overview-amount">{{ teamMembers.length + 1 }}</div>
                  <div class="overview-description">Including team lead</div>
                </div>
              </div>
            </div>
            ...
            <div class="overview-item">
              <div class="overview-card category-card">
                <div class="overview-icon-wrapper category-icon">
                  <v-icon class="overview-icon" color="white">mdi-tag</v-icon>
                </div>
                <div class="overview-info">
                  <h3 class="overview-title">Category</h3>
                  <div class="overview-amount">{{ category }}</div>
                  <div class="overview-description">Project type</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <v-row>
              ...
              <v-col cols="12" md="8">
                <div class="project-card">
                  ...
                  <div class="card-content">
                    <div class="form-group">
                      <h4 class="field-label">Project Title</h4>
                      <v-text-field
                    ...
                    <div class="form-group">
                      <h4 class="field-label">Thumbnail Image</h4>
                      <div class="file-upload-area" @click="triggerThumbnailUpload">
                        ...
                        <div v-else class="upload-success">
                          ...
                          <div class="upload-text">{{ thumbnailFile.name }}</div>
                    ...
                    <div class="form-group">
                      <h4 class="field-label">Project Description</h4>
                    ...
                    <v-row>
                      <v-col cols="12" sm="4">
                        <div class="form-group">
                          <h4 class="field-label">Priority</h4>
                          <v-select
                            v-model="priority"
                      ...
                      <v-col cols="12" sm="4">
                        <div class="form-group">
                          <h4 class="field-label">Deadline</h4>
                          <v-text-field
                            v-model="deadline"
                            type="date"
                            variant="outlined"
                ...
                <div class="project-card">
                  <div class="card-header">
                    ...
                    <p class="card-subtitle">Upload project resources and documentation</p>
                  </div>
                  ...
                  <div class="card-content">
                    <div class="file-drop-zone" @drop="handleFileDrop" @dragover.prevent @dragenter.prevent>
                      <div class="drop-zone-content">
                        ...
                        <p class="drop-subtitle">Support for multiple file formats</p>
              ...
              <v-col cols="12" md="4">
                <div class="project-card">
                  ...
                  <div class="card-content">
                    <div class="form-group">
                      <h4 class="field-label">Privacy</h4>
                      <v-select
                        v-model="privacy"
                ...
                <div class="project-card">
                  <div class="card-header">
                    <h3 class="card-title">Tags & Categories</h3>
                  </div>
                  ...
                  <div class="card-content">
                    ...
                    <div class="form-group">
                      <h4 class="field-label">Skills Required</h4>
                ...
                <div class="project-card">
                  ...
                  <div class="card-content">
                    <div class="form-group">
                      <h4 class="field-label">Team Lead</h4>
                      <v-select
                        v-model="teamLead"
                    ...
                    <div class="form-group">
                      <h4 class="field-label">Team Members</h4>
