    ...
    <div>
      ...
      <v-app>
        <v-navigation-drawer
          ...
          width="65"
        >
          <v-list class="d-flex flex-column align-center pa-0" nav>
            <v-list-item class="mb-2">
              <v-avatar color="teal-darken-4" class="my-2">
                <span class="text-h6 text-white">FT</span>
              </v-avatar>
            </v-list-item>
            
            <v-list-item v-for="item in menuItems" :key="item.icon" class="my-1">
            ...
            <v-list-item v-for="person in teamMembers" :key="person.id" class="my-1">
              <v-avatar size="36">
        ...
        <v-main class="bg-grey-lighten-4">
          <v-container fluid class="pa-6">
            <v-row class="mb-4" no-gutters>
              <v-col cols="6">
                <div class="text-h5 font-weight-bold">PROJECT LIST</div>
              </v-col>
            ...
            <v-row>
              <!-- New Tasks Column -->
              <v-col cols="12" md="4">
                <v-card class="rounded-lg mb-6" color="grey-darken-3">
                  <v-card-title class="text-white pa-6">New Tasks</v-card-title>
                </v-card>
                ...
                >
                  ...
                  <div class="d-flex justify-space-between align-center">
                    <div class="d-flex">
                      ...
                      >
                        <v-img :src="getTeamMemberAvatar(memberId)"></v-img>
                      </v-avatar>
                    ...
                    <div class="d-flex flex-column align-end">
                      ...
                      <div class="text-caption font-weight-medium">{{ task.date }}</div>
                    </div>
                  </div>
              ...
              <v-col cols="12" md="4">
                <v-card class="rounded-lg mb-6" color="grey-darken-3">
                  <v-card-title class="text-white pa-6">In progress</v-card-title>
                </v-card>
              ...
              <v-col cols="12" md="4">
                <v-card class="rounded-lg mb-6" color="grey-darken-3">
                  <v-card-title class="text-white pa-6">Completed</v-card-title>
                </v-card>
            ...
            <v-row justify="center" class="mt-8">
              <v-col cols="auto">
                <v-btn variant="text" class="mx-1">Previous</v-btn>
                <v-btn 
                  v-for="page in 4" 
                  :key="page" 
                ...
                <v-btn color="teal-darken-1" variant="flat" class="mx-1">Next</v-btn>
              </v-col>
            </v-row>
          </v-container>
        </v-main>
