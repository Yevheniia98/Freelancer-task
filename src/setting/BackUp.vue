      ...
      >
        ...
        >
          ...
          <div class="backup-container">
            <h1 class="text-h4 font-weight-bold mb-8">Backup & Data Management</h1>
            
            <!-- Backup Status Section -->
            <div class="mb-10">
              <h2 class="text-h5 font-weight-bold mb-4">Backup Status</h2>
              
              <v-card class="pa-6 mb-6" variant="outlined">
                <div class="d-flex justify-space-between align-center mb-4">
                  <div>
                    <h3 class="text-h6 font-weight-medium mb-1">Automatic Backups</h3>
                    <p class="text-body-2 text-grey">Your data is automatically backed up every day</p>
                  </div>
                ...
                <div class="d-flex justify-space-between align-center">
                  <div>
                    <p class="text-body-2">Last backup: <span class="font-weight-medium">Today, 4:30 AM</span></p>
                    <p class="text-body-2">Backup frequency: <span class="font-weight-medium">Daily</span></p>
                  </div>
                  <v-btn color="primary" variant="flat" prepend-icon="mdi-backup-restore">
                    Run Manual Backup
                  </v-btn>
                </div>
              </v-card>
            ...
            <div class="mb-10">
              <h2 class="text-h5 font-weight-bold mb-4">Backup Settings</h2>
              
              <v-card class="pa-6 mb-6" variant="outlined">
                <h3 class="text-h6 font-weight-medium mb-6">Backup Schedule</h3>
                ...
                <h3 class="text-h6 font-weight-medium mb-3">Data to Include</h3>
                ...
                <div class="d-flex justify-end">
                  <v-btn color="primary" variant="flat" @click="saveBackupSettings">
                    Save Settings
                  </v-btn>
                </div>
              </v-card>
            ...
            <div class="mb-10">
              <h2 class="text-h5 font-weight-bold mb-4">Data Management</h2>
              
              <v-card class="pa-6 mb-6" variant="outlined">
                <div class="d-flex justify-space-between align-center mb-6">
                  <div>
                    <h3 class="text-h6 font-weight-medium mb-1">Storage Usage</h3>
                    <p class="text-body-2 text-grey">Your account is using 12.4 GB of 20 GB (62%)</p>
                  </div>
                ...
                <v-table class="mb-4">
                  ...
                  <tbody>
                    <tr v-for="(item, index) in storageBreakdown" :key="index">
                      <td>{{ item.type }}</td>
                      <td>{{ item.usage }}</td>
                ...
                <div class="d-flex justify-end">
                  <v-btn color="error" variant="text" @click="showDataClearDialog = true">
            ...
            <!-- Data Export Section -->
            <div>
              <h2 class="text-h5 font-weight-bold mb-4">Data Export</h2>
              ...
              <v-card class="pa-6" variant="outlined">
                ...
                <div class="d-flex gap-6 mb-6">
                  ...
                  <v-btn color="primary" variant="flat" class="mt-2" @click="exportData">
                    Export Data
                  </v-btn>
                </div>
