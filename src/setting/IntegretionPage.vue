      ...
      >
        ...
        >
          ...
          <div class="integrations-container">
            <h1 class="text-h4 font-weight-bold mb-8">Integrations</h1>
            
            <!-- Available Integrations Section -->
            <div class="mb-8">
              <h2 class="text-h5 font-weight-bold mb-3">Available Integrations</h2>
              <p class="text-body-1 mb-6">Connect powerful tools to enhance your experience.</p>
            ...
            <div class="mb-8">
              <h2 class="text-h5 font-weight-bold mb-6">Featured Integrations</h2>
              ...
              <v-table class="rounded-lg">
                ...
                <tbody>
                  <tr v-for="(integration, index) in featuredIntegrations" :key="index">
            ...
            <div class="mb-8">
              <h2 class="text-h5 font-weight-bold mb-6">Integration Cards</h2>
              ...
              <v-table class="rounded-lg">
                ...
                <tbody>
                  <tr v-for="(card, index) in integrationCards" :key="index">
            ...
            <div>
              <h2 class="text-h5 font-weight-bold mb-6">Connection & Setup Guide</h2>
              ...
              <v-table class="rounded-lg">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>Support: <a href="#" class="text-primary">Contact Us</a></td>
                  </tr>
                </tbody>
              </v-table>
            </div>
